...
\TLV
   ...
   $next_pc[31:0] = $reset ? 32'b0 : >>1$next_pc[31:0] + 32'd4;
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, {$rd_valid}&&{$rd != 5'b0}, $rd, $result[31:0], $rs1_valid, $rs1[4:0], $src1_value, $rs2_valid, $rs2[4:0], $src2_value)
